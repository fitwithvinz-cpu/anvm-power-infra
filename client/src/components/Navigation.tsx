      ...
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <Link href="/">
          <a className="flex items-center gap-2 text-2xl font-bold text-primary hover:text-secondary transition-colors">
            ...
            <span className="hidden sm:inline text-lg">ANVM Power Infra Pvt. Ltd.</span>
          </a>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-8">
          {navLinks.map((link) => (
            <Link key={link.href} href={link.href}>
              <a className="text-foreground hover:text-primary font-medium transition-colors relative group">
                {link.label}
        ...
        <div className="hidden md:block">
          <Link href="/contact">
            <a className="bg-primary text-primary-foreground px-6 py-2 rounded-lg font-semibold hover:bg-secondary transition-colors">
              Get in Touch
            </a>
          </Link>
        </div>
