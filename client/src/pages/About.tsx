          ...
          <div className="flex items-center justify-between gap-6">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                ...
                <h1 className="text-2xl md:text-3xl font-bold tracking-tight whitespace-nowrap">About ANVM Power Infra Pvt. Ltd.</h1>
              </div>
              <p className="text-sm text-white/70 ml-3 max-w-xl">Established in 2025 with a vision for excellence in electrical and power infrastructure</p>
            </div>
            {/* Logo */}
