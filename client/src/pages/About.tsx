          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <AnimatedSection>
              ...
              <div className="space-y-5 text-lg text-gray-600 leading-relaxed">
                ...
                <p>
                  The company has successfully executed numerous projects in collaboration with <strong className="text-green-700">KPTCL, HESCOM, BESCOM, MESCOM, GESCOM, Wind World India, JSW Renewables, CleanMax, Hero Future Energies, Suzlon, and Vivid Renewables</strong>, along with various private and industrial clients.
                </p>
              </div>
            </AnimatedSection>
