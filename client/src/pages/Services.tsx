      ...
      <section className="relative overflow-hidden text-white" style={{ minHeight: '420px' }}>
        ...
        <div className="container relative z-10 py-24 md:py-32">
          <div className="max-w-2xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 leading-tight">Our Services</h1>
            <p className="text-lg text-white/70 max-w-xl">Comprehensive electrical infrastructure solutions — from high-voltage transmission to renewable energy and civil works across Karnataka</p>
          </div>
        </div>
      </section>
